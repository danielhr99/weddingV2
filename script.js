...
window.onload = function() {
    // יצירת אובייקט של זיקוקים בתוך המיכל
    const fireworks = new Fireworks({
        selector: '.container', // המיכל שבו יופיעו הזיקוקים
        hue: { min: 0, max: 360 }, // צבעים משתנים של הזיקוקים
        delay: { min: 10, max: 30 }, // עיכוב בין כל זיקוק
        speed: 3, // מהירות הזיקוקים
        acceleration: 2, // קצב התפשטות הזיקוקים
        friction: 0.95, // חיכוך
        gravity: 1, // כוח המשיכה
        particles: 100, // כמות הזיקוקים שיתפשטו
    });
    fireworks.start(); // הפעלת הזיקוקים

    // קוד לשליחת נתונים מהטופס לאחר אישור
